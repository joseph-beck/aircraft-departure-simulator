...
CREATE TYPE "public"."carrier_user_type" AS ENUM ('owner', 'admin', 'viewer');
CREATE TYPE "public"."fwd_aft_type" AS ENUM ('fwd', 'aft');
CREATE TYPE "public"."weight_type" AS ENUM ('take_off', 'zero_fuel', 'inflight', 'taxi', 'landing');
...
CREATE TABLE "public"."carrier_map" (
    "carrier" uuid NOT NULL,
    "user" uuid NOT NULL,
    "permission" carrier_user_type NOT NULL
);

CREATE TABLE "public"."fuel_tank_map" (
...
CREATE TABLE "public"."aircraft_weight_map" (
    "registration" uuid NOT NULL,
...
CREATE TABLE "public"."aircraft_weight" (
    "uuid" uuid NOT NULL,
    "name" varchar(16) NOT NULL,
    "weight" bigint NOT NULL,
    "index" bigint NOT NULL,
...
CREATE TABLE "public"."centre_of_gravity_limit_map" (
    "registration" uuid NOT NULL,
...
CREATE TABLE "public"."aircraft_constants" (
    "uuid" uuid NOT NULL,
    "subtype" uuid NOT NULL,
    "name" varchar(16) NOT NULL,
    "c" bigint NOT NULL,
...
CREATE TABLE "public"."ground_stability" (
    "uuid" uuid NOT NULL,
    "subtype" uuid NOT NULL,
    "name" varchar(16) NOT NULL,
    PRIMARY KEY ("uuid")
...
CREATE TABLE "public"."centre_of_gravity_limit" (
    "uuid" uuid NOT NULL,
    "subtype" uuid NOT NULL,
    "name" varchar(16) NOT NULL,
    PRIMARY KEY ("uuid")
...
CREATE TABLE "public"."aircraft_constants_map" (
    "registration" uuid NOT NULL,
...
CREATE TABLE "public"."ground_stability_table" (
...
CREATE TABLE "public"."centre_of_gravity_limit_table" (
...
CREATE TABLE "public"."maximum_weight_map" (
    "registration" uuid NOT NULL,
...
CREATE TABLE "public"."cargo_hold" (
    "uuid" uuid NOT NULL,
    "subtype" uuid NOT NULL,
    "name" varchar(16) NOT NULL,
    "created_at" timestamp NOT NULL,
...
CREATE TABLE "public"."ground_stability_map" (
    "registration" uuid NOT NULL,
    "ground_stability" uuid NOT NULL,
    "effective_date" date NOT NULL,
...
CREATE TABLE "public"."maximum_weight" (
    "uuid" uuid NOT NULL,
    "subtype" uuid NOT NULL,
    "name" varchar(16) NOT NULL,
    "taxi" bigint NOT NULL,
    "landing" bigint NOT NULL,
    "take_off" bigint NOT NULL,
    "zero_fuel" bigint NOT NULL,
    CONSTRAINT "pk_maximum_weight_uuid" PRIMARY KEY ("uuid")
);
...
CREATE TABLE "public"."fuel_tank_table" (
    "weight" bigint NOT NULL,
    "fuel_tank" uuid NOT NULL,
...
CREATE TABLE "public"."cargo_hold_map" (
    "registration" uuid NOT NULL,
...
CREATE TABLE "public"."swa" (
    "uuid" uuid NOT NULL,
    "subtype" uuid NOT NULL,
    "name" varchar(16) NOT NULL,
    "weight" bigint NOT NULL,
    "balance_arm" bigint NOT NULL,
    CONSTRAINT "pk_table_30_id" PRIMARY KEY ("uuid")
);

CREATE TABLE "public"."swa_map" (
    "registration" uuid NOT NULL,
    "swa" uuid NOT NULL,
    "effective_date" date NOT NULL,
    CONSTRAINT "pk_maximum_weight_map_copy_registration_maximum_weights" PRIMARY KEY ("registration", "swa")
);
...
ALTER TABLE "public"."swa_map" ADD CONSTRAINT "fk_swa_map_swa_swa_uuid" FOREIGN KEY("swa") REFERENCES "public"."swa"("uuid");
ALTER TABLE "public"."swa" ADD CONSTRAINT "fk_swa_subtype_subtype_uuid" FOREIGN KEY("subtype") REFERENCES "public"."subtype"("uuid");
ALTER TABLE "public"."swa_map" ADD CONSTRAINT "fk_swa_map_registration_registration_uuid" FOREIGN KEY("registration") REFERENCES "public"."registration"("uuid");
